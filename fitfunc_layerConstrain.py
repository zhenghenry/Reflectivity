...
def reflectivity(q, params, isSLD=False):
                 ...
                 for n in range(0, len(params), 3):
                                  if params[n]>=0: rho=params[n]
                                  else:            rho=params[int(abs(params[n])-5)]
                                  if params[n+1]>=0: d=params[n+1]
                                  else:            d=params[int(abs(params[n+1])-5)]
                                  if params[n+2]>=0: sig=params[n+2]
                                  else:            sig=params[int(abs(params[n+2])-5)]  
